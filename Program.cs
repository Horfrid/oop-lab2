...
namespace laba2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var untypedVariable = "1232512512525 !!!";

            dynamic untypedVariable2 = "some text";
            untypedVariable2 = 6;
            ...
            StringBuilder stringBuild = new StringBuilder("c# builder string");
            stringBuild.Remove(7, 5);
            stringBuild.Insert(0, "Do ");
            stringBuild.Insert((stringBuild.Length), " !!!!!");
            Console.WriteLine("\n" + stringBuild);
           ...
           /*Задание 3: Массивы
            ...
            var secondTuple = (13, 34, "Иван", true);
            ...
            int[] arr = { 4, 5, 6, 7 };
            Console.WriteLine(task5(arr, "Алекс"));
